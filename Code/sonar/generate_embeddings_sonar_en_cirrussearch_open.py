...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(PATH_LOGS + "main_sonar_en_open.log")
    ]
)
    ...
    for language in languages:
        ...
        for type in types:
            ...
            with h5py.File(file_name, 'a') as file:
                ...
                if sub_folder != "en_cirrussearch_open":
                    continue
...
if __name__ == "__main__":
    ...
    create_hdf5_structure(PATH_DATASET + "embeddings_sonar_en_open.hdf5", "SONAR", wiki_types, wiki_languages, wiki_pages)
    fill_hdf5_structure(PATH_DATASET + "embeddings_sonar_en_open.hdf5", "SONAR", wiki_types, wiki_languages)