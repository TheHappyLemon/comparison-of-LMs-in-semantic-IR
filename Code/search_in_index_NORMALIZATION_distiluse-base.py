import h5py
import logging
from constants import PATH_LOGS, PATH_DATASET, CHUNK_SIZE, PATH_SEARCH_FLATIP_NORMALIZED_distiluse_base
import faiss
import numpy as np
import csv
import os
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(PATH_LOGS + "search_NORMALIZED_distiluse-base.log")
    ]
)
...
if __name__ == '__main__':
    ...
    kNN       = [1, 5, 10, 20]
    datasets  = get_dataset_names(hdf5_file, "distiluse-base")
    for index_type in index_types:
        
        if index_type == 'FlatIP':
            path_search_result = PATH_SEARCH_FLATIP_NORMALIZED_distiluse_base
        else:
