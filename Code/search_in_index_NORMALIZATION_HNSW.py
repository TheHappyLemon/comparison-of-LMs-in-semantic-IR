import h5py
import logging
from constants import PATH_LOGS, PATH_DATASET, CHUNK_SIZE, PATH_SEARCH_NORMALIZED_HNSW, PATH_SETUP
import faiss
import numpy as np
import csv
import os
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(PATH_LOGS + "search_NORMALIZED_HNSW.log")
    ]
)
...
if __name__ == '__main__':
    ...
    if choosen_model not in models_dict:
