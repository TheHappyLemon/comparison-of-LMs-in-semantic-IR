import h5py
import logging
from constants import PATH_LOGS, PATH_DATASET, CHUNK_SIZE, PATH_SEARCH_FLATIP_NORMALIZED_LaBSE
import faiss
import numpy as np
import csv
import os
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(PATH_LOGS + "search_NORMALIZED_LaBSE.log")
    ]
)
...
if __name__ == '__main__':
    ...
    kNN       = [1, 5, 10, 20]
    datasets  = get_dataset_names(hdf5_file, "LaBSE")
    for index_type in index_types:
        
        if index_type == 'FlatIP':
            path_search_result = PATH_SEARCH_FLATIP_NORMALIZED_LaBSE
        else:
